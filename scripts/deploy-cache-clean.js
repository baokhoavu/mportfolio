...
runCommand(`${rmCommand} node_modules 2>nul || echo node_modules not found`, 'Removing node_modules');
runCommand(`${rmFileCommand} package-lock.json 2>nul || echo package-lock.json not found`, 'Removing package-lock.json');
