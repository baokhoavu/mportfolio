---
title: "Updating the content of Bob Smith Portfolio"
...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:bob.smith@example.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Bob Smith's Portfolio",
    description: "Portfolio website showcasing my work as a Full Stack Software Engineer",
    headline: <>&lt;&gt;Full stack engineer and innovator&lt;/&gt;</>,
    subline: (
      &lt;&gt;
        I'm Bob, a full stack software engineer at &lt;InlineCode&gt;TechCorp&lt;/InlineCode&gt;, where I build scalable
        &lt;br /&gt; web applications. After hours, I create open source projects.
      &lt;/&gt;
    ),
};`
    language: "tsx",
